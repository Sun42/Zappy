/*
** cmd_unsave.c for cmd_unsave in /u/all/yurdus_y/cu/rendu/c/Zappy2009/server/src
** 
** Made by yavuz yurdusev
** Login   <yurdus_y@epitech.net>
** 
** Started on  Thu Apr 23 20:33:42 2009 yavuz yurdusev
** Last update Thu Apr 23 20:33:42 2009 yavuz yurdusev
*/
...
void	unsave_cmd(t_cli *my_cli, int len, char mode)
{
  if (len < 1)
    return ;
  if (mode == 'R')
    unsave_cmd2(my_cli->lcmdr, &(my_cli->bufr), len);
  if (mode == 'W')
    unsave_cmd2(my_cli->lcmdw, &(my_cli->bufw), len);
}
